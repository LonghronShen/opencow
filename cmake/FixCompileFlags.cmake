if(WIN32 AND (NOT CMAKE_CXX_IS_CLANG_GNU))
...
#   if(MINGW)
#     add_compile_definitions("MINGW_HAS_SECURE_API" "__STDC_WANT_LIB_EXT1__")
#   endif()
else()
...
check_cxx_source_compiles("
    #include<iostream>
    int main() {
        auto v = 0xFFFF000000000000ui64;
        std::cout << v << std::endl;
        return 0;
    }" HAVE_UI64_LITERAL)

if(HAVE_UI64_LITERAL)
    add_compile_definitions("HAVE_UI64_LITERAL=1")
endif()
